...
<!--<script type="text/javascript" src="skins/Skin_(!SKINID!)/gridder-master/dist/js/jquery.gridder.js"></script>-->
...
<div class="row clearfix"><div class="column full" style="padding:0px"><div class="display">
 <div class="col-md-12 col-sm-12 home-slider">
  (!Topic Name="homepagecarousel"!)
  </div>
</div></div></div><!--row clearfix-->
<div class="row clearfix"><div class="column full"><div class="display">

<div class="livechat-float"> (!LIVECHAT!) <!--<img src="skins/Skin_(!SKINID!)/images/online.gif" />--> </div>
<div class="row main-content ltd-width" style="margin-top:10px;">
<div class="col-xs-12">
