...
<div class="footbg">
    ...
    <div id="footerExt" class="row"><div class="large-12 columns copyrighter"><span>Copyright &copy; (!COPYRIGHTYEARS!). All Rights Reserved.</span></div><div class="clr large-12" id="divMobileSwitcher">(!MOBILE_FULLMODE_SWITCHER!)</div></div>
    <!-- END OF FOOTER -->
</div>
    <!-- BUBBLE MESSAGE -->
