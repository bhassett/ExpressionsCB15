  ...
  <div class="clear-both"></div>
   ...
   <asp:Panel ID="pnlPageContentWrapper" runat="server">
        ...
        <asp:Panel ID="pnlResetForm" runat="server" Visible=false>
             <div>
               <p><asp:Literal ID="litResetString1" runat="server">(!createaccount.aspx.146!)</asp:Literal>&nbsp;
               <a href="javascript:void(1);" id="linkResetSignUpForm"><asp:Literal ID="litResetString2" runat="server">(!createaccount.aspx.147!)</asp:Literal></a> <asp:Literal ID="litResetString3" runat="server">(!createaccount.aspx.148!)</asp:Literal></p>
            </div>
        </asp:Panel>
