    ...
    <div id="main">
      <div class="logowrapper" style="background: #FFF;" >
        <div class="shoppingCart"> <a href="default.aspx">
          <div class="logo"> <img src="skins/Skin_(!SKINID!)/images/bunnylux-logo.png" alt="BunnyLux" style="width: 150px;"> </div>
          </a> <b><a href="(!SIGNINOUT_LINK!)" id="signInOutLink">(!SIGNINOUT_TEXT!)</a></b><br />
