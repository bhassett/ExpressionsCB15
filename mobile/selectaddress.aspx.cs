...
namespace InterpriseSuiteEcommerce
{
    ...
    public partial class selectaddress : SkinBase
    {
        ...
        private void InitializePageContent()
        {
            ...
            lnkAddAddress.NavigateUrl = "selectaddress.aspx?add=true&checkout=" + checkOutMode.ToString() + "&addressType=" + AddressType.ToString() + "&returnURL=" + ReturnURL.ToUrlEncode();
        ...
        private void ApplyAddressStyles()
        {
            ...
            litHeaderText.Text = AppLogic.GetString("mobile.createaccount.aspx.1");
        }
        ...
        void AddressList_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
			...
			//mobile changes
            EditBtn.Text = AppLogic.GetString("mobile.selectaddress.aspx.1");
            MakePrimaryBtn.Text = AppLogic.GetString("mobile.selectaddress.aspx.2");
