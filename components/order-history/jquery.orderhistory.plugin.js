(function ($) {
    ...
    var stringResource = {
        ...
        ORDER_DATE: constants.EMPTY_VALUE,
        ORDER_NOTES: constants.EMPTY_VALUE,
        ORDER_NUMBER: constants.EMPTY_VALUE,
        ORDER_TOTAL: constants.EMPTY_VALUE,
        PAYMENT_METHOD: constants.EMPTY_VALUE,
        PAYMENT_STATUS: constants.EMPTY_VALUE,
    ...
    $.fn.OrderHistory = {
        ...
        setStringResourcesValue: function (stringResourceKeys) {
            ...
            stringResource.ORDER_DATE = thisOrderHistory.getString(stringResourceKeys.orderDate);
            stringResource.ORDER_NOTES = thisOrderHistory.getString(stringResourceKeys.orderNotes);
            stringResource.ORDER_NUMBER = thisOrderHistory.getString(stringResourceKeys.orderNumber);
            stringResource.ORDER_TOTAL = thisOrderHistory.getString(stringResourceKeys.orderTotal);
            stringResource.PAYMENT_METHOD = thisOrderHistory.getString(stringResourceKeys.paymentMethod);
            stringResource.PAYMENT_STATUS = thisOrderHistory.getString(stringResourceKeys.paymentStatus);
        ...
        renderOrderHistoryHeader: function () {
            ...
            resources.orderDate = stringResource.ORDER_DATE;
            resources.paymentStatus = stringResource.PAYMENT_STATUS;
            resources.shippingStatus = stringResource.SHIPPING_STATUS;
            resources.orderTotal = stringResource.ORDER_TOTAL;
            resources.orderNotes = stringResource.ORDER_NOTES;
        ...
        renderOrderHistoryContent: function (pageCount, currentpage) {
            var callBack = function (result) {
                ...
                thisOrderHistory.displayOrderHistoryPager(ordersData.rows, ordersData.pages, ordersData.current, pageCount);
        ...
        hideAccountOrderHistoryLink: function () {
            var config = getConfig();
            $(this.selectorChecker(config.accountOrderHistoryLinkId)).hide();
        }
    }
