...
#pnlLoyaltyPoints, #pnlGiftCodes, #pnlPageContentWrapper, #pnlLoyaltyPoints .content, #pnlGiftCodes .content {
	border: none;
	box-shadow: none;
}
#pnlPageContentWrapper {
    ...
    <div class="clear-both height-5"></div>
     <div class="row">
    <asp:Panel ID="pnlNotCheckOutButtons" CssClass="col-sm-6" runat="server" HorizontalAlign="left">
      <asp:Image ID="redarrow1" AlternateText="" CssClass="display-none" runat="server" />
      <asp:HyperLink runat="server" ID="accountaspx4" NavigateUrl="#OrderHistory" CssClass="btn btn-default btn-block" Text="(!account.aspx.3!)"></asp:HyperLink>
     </asp:Panel>
      <asp:Panel ID="pnlShowWishButton" CssClass="col-sm-6" runat="server">
        <asp:Image ID="redarrow2" AlternateText="" runat="server"
        CssClass="display-none" />
        <asp:HyperLink runat="server" ID="ShowWishListButton" NavigateUrl="~/wishlist.aspx" CssClass="btn btn-default btn-block" Text="(!account.aspx.23!)"></asp:HyperLink>
        </asp:Panel>
        </div>
    ...
    <form id="AccountForm" runat="server">
          ...
          <div class="section-content-wrapper">
            <div>
              ...
              <div id="profile-info-wrapper" style="padding:12px;">
                <div id="profile-account-info-place-holder" class="float-left"> <span class="form-section">
                  ...
                  <div class="clear-both height-12 profile-section-clears"></div>
                  <div class="clear-both height-5"></div>
                  <div id="account-section-wrapper"> <span class="form-section custom-font-style">
                    <asp:Literal ID="litAdditionalInfo" runat="server">(!account.aspx.64!)</asp:Literal>
                    </span>
                    <div class="clear-both height-12"></div>
                    <div class="form-controls-place-holder" style="display:none"> <span class="form-controls-span">
                  ...
                  <div class="form-controls-place-holder captcha-section"> <span class="form-controls-span custom-font-style" id="captcha-label" style="padding-right:17px !important;">
            ...
            <div id="profile-info-button-place-holder">
              <div id="save-profile-button">
                ...
                <div id="save-profile-button-place-holder">
                  <input type="button" class="btn btn-default content" id="update-profile" 
                  ...
                  <asp:Button ID="btnContinueToCheckOut" CssClass="btn btn-default" Text="(!account.aspx.24!)" runat="server" CausesValidation="false" OnClick="btnContinueToCheckOut_Click" />
                </div>
              </div>
            </div>
            <div class="clear-both"></div>
     ...
     <div class="col-md-6">
      <%-- div section for address book starts here --%>
      <div class="sections-place-holder well well-sm no-padding">
        <div class="section-header section-header-top">
          <asp:Literal ID="Literal7" runat="server">(!account.aspx.67!)</asp:Literal>
        </div>
        <div class="section-content-wrapper">
          <div id="Div2">
            <div id="Div3" style="padding:10px;">
              <div style=""> <b>
                <asp:Label ID="accountaspx30" runat="server" Text="(!account.aspx.8!)"></asp:Label>
                &#160;&#160;&#160;&#160;</b>
                <asp:HyperLink ID="lnkChangeBilling" runat="server" CssClass="hyperlinkImageStyle btn btn-default button-xs"> Change </asp:HyperLink>
                <br/>
              ...
              <div style="">
                <asp:Panel ID="pnlShipping" runat="server">
                  <b>
                  <asp:Label ID="accountaspx32" runat="server" Text="(!account.aspx.10!)"></asp:Label>
                  &#160;&#160;&#160;&#160;</b>
                  <asp:HyperLink ID="lnkChangeShipping" runat="Server" CssClass="hyperlinkImageStyle btn btn-default button-xs" Text="" ></asp:HyperLink>
                  <br/>
      ...
      <asp:Panel ID="pnlGiftCodes" runat="server">
        <div class="sections-place-holder well well-sm no-padding">
          ...
          <div class="section-content-wrapper">
            <div class="content"> <a href="javascript:void(0)" id="btnViewGiftCodes" class="btn btn-info btn-block"><%= AppLogic.GetString("account.aspx.46") %></a>
              <div id="giftCode" style="display:none;"> <span id="lblNoGiftCodesFound"> <%= AppLogic.GetString("account.aspx.47") %> </span>
            ...
            <div class="content" id="loyaltyPoints">
              <table>
                <tr>
                  ...
                  <td><asp:Label ID="lblPoints" runat="server" CssClass="points"></asp:Label></td>
                </tr>
                <tr>
                  <td class="caption"><%= AppLogic.GetString("account.aspx.54") %></td>
                  <td><asp:Label ID="lblMonetaryValue" runat="server" CssClass="value"></asp:Label></td>
                </tr>
              </table>
            </div>
          </div>
      ...
      <div class="sections-place-holder well well-sm no-padding">
        <div class="section-header section-header-top">
          <asp:Literal ID="Literal4" runat="server">(!account.aspx.79!)</asp:Literal>
        </div>
        <div class="section-content-wrapper"> <a name="OpenInvoices"></a>
          <div id="AccountOpenInvoices" style="border: none !important">
            <div id="accountOpenInvoicesLink"  runat="server"><a id="lnkOpenInvoices" href="javascript:void(0);" class="btn btn-info btn-block"><%=AppLogic.GetString("account.aspx.80", true)%></a></div>
      ...
      <div class="sections-place-holder well well-sm no-padding">
        ...
        <div class="section-content-wrapper"> <a name="OrderHistory"></a>
          <div id="AccountOrderHistory" style="border: none !important">
            <div id="accountOrderHistoryLink" runat="server" ><a id="lnkOrderHistory" href="javascript:void(0)" class="btn btn-info btn-block"><%=AppLogic.GetString("account.aspx.30", true)%></a></div>
      ...
      <!-- do not remove -->
      <input type="hidden" id="load-at-page" value="edit-profile" />
      <!-- do not remove -->
