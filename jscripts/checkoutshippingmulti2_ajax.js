...
ise.Pages._CheckOutShippingMulti2.prototype = {
    ...
    registerShippingMethodControlId : function(id) {
        ...
        if(control) {
            ...
            var addControlDelegate = Function.createDelegate(this, this.addShippingMethodControl);
            var observer =  {
                notify : function(registeredControl) {
                    if(registeredControl.id == id) { addControlDelegate(registeredControl); }                    
                }
            }
    ...
    setExpectedCount : function(count) { this.expectedCount = count; },
